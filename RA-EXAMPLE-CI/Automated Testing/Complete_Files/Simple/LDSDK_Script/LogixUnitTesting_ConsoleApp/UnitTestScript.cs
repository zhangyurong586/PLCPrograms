...
namespace SimpleExample
{
    public class SimpleExampleClass
    {
        static async Task Main()
        {
            ...
            string acdFilePath = @"C:\Lab Files\Automated Testing\Complete_Files\Simple\ACD_UnderTest\LDSDKdemo_simpleEx_L85E_v36.ACD";
            ...
            string area_comparison2_result_XPath = "Controller/Tags/Tag[@Name='area_comparison_result2']";             // Controller scoped (output)
            ...
            bool testCase1_cmpResult2 = await logixProject.GetTagValueBOOLAsync(area_comparison2_result_XPath, LogixProject.OperationMode.Online);
            ...
            failureCondition += TEST_CompareForExpectedValue("area_comparison_result2", "FALSE", testCase1_cmpResult2.ToString().ToUpper(), true);
            ...
            bool testCase2_cmpResult2 = await logixProject.GetTagValueBOOLAsync(area_comparison2_result_XPath, LogixProject.OperationMode.Online);
            ...
            failureCondition += TEST_CompareForExpectedValue("area_comparison_result2", "FALSE", testCase2_cmpResult2.ToString().ToUpper(), true);
            ...
            bool testCase3_cmpResult2 = await logixProject.GetTagValueBOOLAsync(area_comparison2_result_XPath, LogixProject.OperationMode.Online);
            ...
            failureCondition += TEST_CompareForExpectedValue("area_comparison_result2", "TRUE", testCase3_cmpResult2.ToString().ToUpper(), true);
